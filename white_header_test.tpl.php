...
<head>
	...
	*,::after,::before{box-sizing:border-box}body{margin:0;font-family:system-ui,-apple-system,"Segoe UI",Roboto,"Helvetica Neue",Arial,sans-serif;font-size:1rem;line-height:1.5;background:#f6f8fa}
	...
	<link href="assets/css/bootstrap-icons.css" rel="stylesheet" media="print" onload="this.media='all'">
	<noscript><link href="assets/css/bootstrap-icons.css" rel="stylesheet"></noscript>
  <link rel="stylesheet" href="<?= BASE_URL; ?>assets/css/trusted-shops.css?v=1.0.3" media="print" onload="this.media='all'">
	<noscript><link rel="stylesheet" href="<?= BASE_URL; ?>assets/css/trusted-shops.css?v=1.0.3"></noscript>
	<!-- Load Font Awesome asynchronously to prevent render blocking -->
	...
	<link rel="preload" as="image" href="<?=BASE_URL;?><?=$cur_LogoDark;?>" fetchpriority="high">
