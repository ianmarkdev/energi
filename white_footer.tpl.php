        ...
        <div class="textwidget" style="display: flex;">
          ...
          <p>
            <a href="<?= BASE_URL; ?>trustedshops">
              <img decoding="async" class="size-full wp-image-142 alignnone trusted-shop-logo" src="<?= BASE_URL; ?>assets/images/trusted-shops-seal.webp" alt="Siegel Vertrauenswürdige Händler" width="134" height="134" style="margin-top:5px;">
            </a>
            <a href="<?= BASE_URL; ?>trustedshops">
...
<?php if ($is_File_Name == "index.php" or $is_File_Name == "heiz_calc.php") { ?>
