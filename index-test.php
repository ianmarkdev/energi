<?php
	...
	include("white_header_test.tpl.php");
...
<section class="hero-section position-relative" style="<?php if($detectMobile->isMobile()) { echo 'display:none!important;'; } ?>">
  ...
  <div class="container hero-content py-5">
    <div class="col-md-7 col-lg-6">
      <div class="hero-headline mb-3">
        Heizöl zu unschlagbaren Preisen
            </div>
            <hr style="border-top:2px solid #fff; opacity:.7;">
            <div class="hero-subline mb-4" style="color:#fff;">
                Wir bieten einen allumfassenden Service in Sachen Heizöl bei attraktivsten Konditionen zu blitzschnellen Lieferzeiten. Gerne beraten wir dich auch persönlich - jetzt unverbindlich bei uns anfragen.
            </div>
...
<?php
	...
	include("white_footer_test.tpl.php");
